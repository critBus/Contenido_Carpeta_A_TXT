...
//    public void copiarSubtitulosACapitulos(ConfiguracionDeVideo cdv) throws IOException {
//        for (int i = 0; i < series.size(); i++) {
//            for (int j = 0; j < series.get(i).getTemporadas().size(); j++) {
//                ForCapitulos:
//                for (int k = 0; k < series.get(i).getTemporadas().get(j).getCapitulos().size(); k++) {
...
//                        LinkedList<Subtitulo_De_Serie> S = series.get(i).getTemporadas().get(j).getSubtitulos(c.getCapituloInicial());
//                        if (c.getDireccion().isFile()) {
//                            copiarSubtitulosA(c.getDireccion(), S, true);
//
//                        } else {
//                            File F[] = c.getDireccion().listFiles();
//                            for (int l = 0; l < F.length; l++) {
...
//
//                            }
//                            copiarSubtitulosA(c.getDireccion(), S, false);
//
//                        }
//                    }
//                }
...
//        }
//    }
//    private void copiarSubtitulosA(File capitulo, LinkedList<Subtitulo_De_Serie> S, boolean utilizarMismoNombre) throws IOException {
//        for (int i = 0; i < S.size(); i++) {
//            if (utilizarMismoNombre && i == 0) {
//                File mismoNombre = new File(capitulo.toString());
////                System.out.println("************************************************");
////                System.out.println("S.get(i).getDireccion()=" + S.get(i).getDireccion());
////                System.out.println("mismoNombre=" + mismoNombre);
//
//                mismoNombre = Archivo.sustituirExtencionFalsa(mismoNombre, S.get(i).getExtencion());
