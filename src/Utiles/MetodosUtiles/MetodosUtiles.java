...
//ConfiguracionDeVideo cdv cantidadAntesIngnorar[  separacionString
    ...
    public static final String terminacionesNumericas[][] = {{}, {"ra", "er"}, {"da", "do", "nd"}, {"ra", "ro", "rd"}, {"ta", "to"}, {"ta", "to"}, {"ta", "to"}, {"ta", "tima", "to", "timo"}, {"ba", "va", "bo", "vo"}, {"na", "no"}};
...
//<b></b>
    ...
    //<li></li>
//
//    public static <E> Class getClassDeE() {
//        E e = null;
...
////                return e.getClass();
////            }
////        Callback<E,File> file=(v)->(File) ((E) new File(""));
////        Callback<E,String> string=(v)->(String) ((E) new String(""));
////        Predicate<Callback<E,Class>> p=v->{
////            try {
////            E e=    (E) v.call(null);
////                System.out.println("e="+e);
////                System.out.println("ecl="+e.getClass().getSimpleName());
////                return true;
////            } catch (ClassCastException e) {
////                return false;
////            }
...
////        }; 
////        int a[]={};
////         Callback clases[]={file,string};
////         for (int i = 0; i < clases.length; i++) {
////            if(p.test(clases[i])){
////            return  clases[i].call(null).getClass();
////            }
////        }
//
//        return null;
//    }
    public static boolean entreAll(double menores, double mayores,boolean iguales, double ... numeros) {
        for (double n : numeros) {
            if(!entre(menores, n, mayores, iguales)){
                return false;
            }
        }
        return true;
    ...
    public static boolean isEmptyAll(String... A){
        for (String a : A) {
            if(!StringRealmenteVacio(a)){
            return false;
            }
    ...
    public static String redondearA3String(double n) {
        return redondearAString(n, 3);
    }
    ...
    public static String unirString(Callback<String, String> c, double A[]) {
...
////            System.out.println("A[i]="+A[i]);
    ...
    public static String unirStringO(Callback<String, String> c, Object A[]) {
//        System.out.println("object");
    ...
    public static boolean esNaN(double a) {
//        System.out.println("a="+a);
//        System.out.println("a == java.lang.Double.NaN="+(a == java.lang.Double.NaN));
//        return a == java.lang.Double.NaN;
        return (a + "").equals("NaN");
    }

    public static String[] getLineasString(String a) {
...
//        return new BigDecimal(numero.toString().substring(0, i));
    ...
    public static String eliminarCerosDerecha(double numero) {
        return eliminarCerosDerecha(numero + "");
    }

    public static String eliminarCerosDerecha(String numero) {
        int i = numero.length();//numero.charAt(i - 1) == '0'
    ...
    public static boolean esPIN(int cantidadDeDigitos, String numero) {
        return !numero.isEmpty() && numero.length() == cantidadDeDigitos && esNumeroAll(numero);
    }
...
//        return respuesta;
    ...
    public static boolean esPor(String a, int indice, String permitidosAntes[], String permitidosAConinuacion[]) {
        ...
        if ((esNumeroAll(a.charAt(indice) + "") && (esNumeroAll(a.charAt(indice - 1) + "")))
...
//****************
    ...
    public static boolean or(String a, boolean toLowerCase, String[] B, String... C) {

        return or(a, toLowerCase, B) || or(a, toLowerCase, C);
    }
...
//            }
     ...
     * @return
     */
    public static boolean orChar(char a, char... B) {
        for (char b : B) {
            if (a == b) {
                return true;
            }
